...
define_header_lt(ixx)
define_header_lt(string)
define_header_lt(file)
...
define_header_leqt(ixx)
define_header_leqt(string)
define_header_leqt(file)
...
define_header_gt(ixx)
define_header_gt(string)
define_header_gt(file)
...
define_header_geqt(ixx)
define_header_geqt(string)
define_header_geqt(file)

define_header_neq(bool)
define_header_neq(i16)
define_header_neq(i32)
define_header_neq(i64)
define_header_neq(ui16)
define_header_neq(ui32)
define_header_neq(ui64)
define_header_neq(f32)
define_header_neq(f64)
define_header_neq(f80)
define_header_neq(ixx)
define_header_neq(string)
define_header_neq(file)
...
define_header_eq(ixx)
define_header_eq(string)
define_header_eq(file)
