...
mpz_t G552;
mpz_init_set(G552,value1_2);
mpz_t G553;
mpz_init_set_str(G553,"500",10);
mpz_add(G552,G552,G553);
mpz_t G555;
mpz_init_set_str(G555,"0",10);
mpz_add(G552,G552,value2_2);
mpz_t G557;
mpz_init_set_str(G557,"0",10);
mpz_add(G552,G552,value3_2);
mpz_t G559;
mpz_init_set_str(G559,"1000",10);
mpz_add(G552,G552,G559);
prnl_ixx((ixx_cast)(G552));
mpz_t G561;
...
mpz_sub(G561,G561,G564);
mpz_t G567;
mpz_init_set_str(G567,"0",10);
mpz_sub(G561,G561,value2_2);
prnl_ixx((ixx_cast)(G561));
mpz_t G569;
mpz_init_set(G569,value1_2);
mpz_t G570;
mpz_init_set_str(G570,"0",10);
mpz_mul(G569,G569,value2_2);
prnl_ixx((ixx_cast)(G569));
mpz_t G572;
mpz_init_set(G572,value1_2);
mpz_t G573;
mpz_init_set_str(G573,"0",10);
mpz_div(G572,G572,value2_2);
prnl_ixx((ixx_cast)(G572));
println_f64(((100000/100)*(1000-500)*sqrt(9)));
mpz_t G576;
mpz_init_set_str(G576,"100000",10);
mpz_t G577;
mpz_init_set_str(G577,"100",10);
mpz_div(G576,G576,G577);
mpz_t G581;
mpz_init_set_str(G581,"1000",10);
mpz_t G582;
mpz_init_set_str(G582,"500",10);
mpz_sub(G581,G581,G582);
mpz_mul(G576,G576,G581);
mpz_t G586;
mpz_init_set_str(G586,"9",10);
mpz_sqrt(G586,G586);
mpz_mul(G576,G576,G586);
prnl_ixx((G576));
println_f64((10*pow(2,64)));
mpz_t G587;
mpz_init_set_str(G587,"10",10);
mpz_t G590;
mpz_init_set_str(G590,"2",10);
mpz_t G591;
mpz_init_set_str(G591,"64",10);
mpz_t G592;
mpz_init_set_str(G592,"340282366920938463463374607431768211456",10);
mpz_powm(G590,G590,G591,G592);
mpz_mul(G587,G587,G590);
prnl_ixx((G587));
mpz_t G593;
mpz_init_set_str(G593,"990",10);
mpz_t G594;
mpz_init_set_str(G594,"1000",10);
mpz_mul(G593,G593,G594);
set_pointer_ixx(&value1_2,(G593));
print_string("Value1 redef: ");
prnl_ixx(value1_2);
mpz_t G596;
mpz_init_set_str(G596,"0",10);
create_str_ixx(G596,"500");
println_f64((f64)((100000/100)*(1000-mpz_get_si(G596))));
mpz_t G598;
mpz_init_set_str(G598,"100000",10);
mpz_t G599;
mpz_init_set_str(G599,"100",10);
mpz_div(G598,G598,G599);
mpz_t G603;
mpz_init_set_str(G603,"1000",10);
mpz_t G604;
mpz_init_set_str(G604,"500",10);
mpz_sub(G603,G603,G604);
mpz_mul(G598,G598,G603);
prnl_ixx((ixx_cast)(G598));
mpz_t G607;
mpz_init_set_str(G607,"100000",10);
mpz_t G608;
mpz_init_set_str(G608,"100",10);
mpz_div(G607,G607,G608);
mpz_t G612;
mpz_init_set_str(G612,"1000",10);
mpz_t G613;
mpz_init_set_str(G613,"500",10);
mpz_sub(G612,G612,G613);
mpz_mul(G607,G607,G612);
prnl_ixx((ixx_cast)(ixx_cast)(ixx_cast)(G607));
}
}
i32 main()
{
