...
{
mpz_t G550;
mpz_init_set_si(G550,5000);
mpz_t G551;
mpz_init_set_si(G551,2);
mpz_t G552;
mpz_init_set_si(G552,3);
mpz_t G553;
mpz_init_set_si(G553,5000);
mpz_t G554;
