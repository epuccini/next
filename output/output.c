...
mpz_t G552;
mpz_init_set_str(G552,"1000",10);
mpz_add(G548,G552,G548);
prnl_ixx((G548));
mpz_t G553;
mpz_init_set_str(G553,"0",10);
mpz_sub(G553,value1_2,G553);
mpz_sub(G553,value2_2,G553);
prnl_ixx((G553));
mpz_t G556;
mpz_init_set_str(G556,"1",10);
mpz_mul(G556,value1_2,G556);
mpz_mul(G556,value2_2,G556);
prnl_ixx((G556));
mpz_t G559;
mpz_init_set_str(G559,"1",10);
mpz_div(G559,value1_2,G559);
