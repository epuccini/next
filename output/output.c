...
i64 value4_2=mpz_get_si(G545);
println_string("Bigints!!!");
mpz_t G546;
mpz_init_set_str(G546,"0",10);
create_str_ixx(G546,"10000");
prnl_ixx(G546);
print_string("Value1: ");
prnl_ixx(value1_2);
print_string("Value2: ");
...
mpz_t G547;
mpz_init_set(G547,value1_2);
mpz_t G548;
mpz_init_set_str(G548,"500",10);
mpz_add(G547,G547,G548);
mpz_t G550;
mpz_init_set_str(G550,"0",10);
mpz_add(G547,G547,value2_2);
mpz_t G552;
mpz_init_set_str(G552,"0",10);
mpz_add(G547,G547,value3_2);
mpz_t G554;
mpz_init_set_str(G554,"1000",10);
mpz_add(G547,G547,G554);
prnl_ixx((ixx_cast)(G547));
mpz_t G556;
mpz_init_set(G556,value1_2);
mpz_t G559;
mpz_init_set(G559,value1_2);
mpz_t G560;
mpz_init_set_str(G560,"0",10);
mpz_mul(G559,G559,value2_2);
mpz_sub(G556,G556,G559);
mpz_t G562;
mpz_init_set_str(G562,"0",10);
mpz_sub(G556,G556,value2_2);
prnl_ixx((ixx_cast)(G556));
mpz_t G564;
mpz_init_set(G564,value1_2);
mpz_t G565;
mpz_init_set_str(G565,"0",10);
mpz_mul(G564,G564,value2_2);
prnl_ixx((ixx_cast)(G564));
mpz_t G567;
mpz_init_set(G567,value1_2);
mpz_t G568;
mpz_init_set_str(G568,"0",10);
mpz_div(G567,G567,value2_2);
prnl_ixx((ixx_cast)(G567));
println_f64(((100000/100)*(1000-500)*sqrt(9)));
mpz_t G571;
mpz_init_set_str(G571,"100000",10);
mpz_t G572;
mpz_init_set_str(G572,"100",10);
mpz_div(G571,G571,G572);
mpz_t G576;
mpz_init_set_str(G576,"1000",10);
mpz_t G577;
mpz_init_set_str(G577,"500",10);
mpz_sub(G576,G576,G577);
mpz_mul(G571,G571,G576);
mpz_t G581;
mpz_init_set_str(G581,"9",10);
mpz_sqrt(G581,G581);
mpz_mul(G571,G571,G581);
prnl_ixx((G571));
println_f64((10*pow(2,64)));
mpz_t G582;
mpz_init_set_str(G582,"10",10);
mpz_t G585;
mpz_init_set_str(G585,"2",10);
mpz_t G586;
mpz_init_set_str(G586,"64",10);
mpz_t G587;
mpz_init_set_str(G587,"340282366920938463463374607431768211456",10);
mpz_powm(G585,G585,G586,G587);
mpz_mul(G582,G582,G585);
prnl_ixx((G582));
mpz_t G588;
mpz_init_set_str(G588,"990",10);
mpz_t G589;
mpz_init_set_str(G589,"1000",10);
mpz_mul(G588,G588,G589);
set_pointer_ixx(&value1_2,(G588));
print_string("Value1 redef: ");
prnl_ixx(value1_2);
mpz_t G591;
mpz_init_set_str(G591,"0",10);
create_str_ixx(G591,"500");
println_f64((f64)((100000/100)*(1000-mpz_get_si(G591))));
mpz_t G593;
mpz_init_set_str(G593,"100000",10);
mpz_t G594;
mpz_init_set_str(G594,"100",10);
mpz_div(G593,G593,G594);
mpz_t G598;
mpz_init_set_str(G598,"1000",10);
mpz_t G599;
mpz_init_set_str(G599,"500",10);
mpz_sub(G598,G598,G599);
mpz_mul(G593,G593,G598);
prnl_ixx((ixx_cast)(G593));
mpz_t G602;
mpz_init_set_str(G602,"100000",10);
mpz_t G603;
mpz_init_set_str(G603,"100",10);
mpz_div(G602,G602,G603);
mpz_t G607;
mpz_init_set_str(G607,"1000",10);
mpz_t G608;
mpz_init_set_str(G608,"500",10);
mpz_sub(G607,G607,G608);
mpz_mul(G602,G602,G607);
prnl_ixx((ixx_cast)(ixx_cast)(ixx_cast)(G602));
}
}
i32 main()
{
