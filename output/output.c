...
print_string("Mylist");
push_node_list_f32(my_list_2,888.0);
println_list_f32(my_list_2);
print_string("Mylistcar");
println_f32((f32)car_node_list_f32(my_list_2));
print_string("Mylistremove3");
remove_node_list_f32(my_list_2,3);
println_list_f32(my_list_2);
print_string("Mylistpop");
println_f32((f32)pop_node_list_f32(&my_list_2));
print_string("Mylist");
println_list_f32(my_list_2);
