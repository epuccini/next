...
mpz_t G553;
mpz_init_set_str(G553,"1000",10);
mpz_add(G549,G549,G553);
...
mpz_sub(G554,G554,G556);
mpz_t G558;
mpz_init_set_str(G558,"0",10);
mpz_sub(G554,G554,value2_2);
prnl_ixx((ixx_cast)(G554));
mpz_t G559;
...
mpz_div(G561,G561,value2_2);
prnl_ixx((ixx_cast)(G561));
println_f64(((100000/100)*(1000-500)));
mpz_t G564;
mpz_init_set_str(G564,"100000",10);
mpz_t G565;
mpz_init_set_str(G565,"100",10);
mpz_div(G564,G564,G565);
mpz_t G567;
mpz_init_set_str(G567,"1000",10);
mpz_t G568;
...
prnl_ixx((G564));
mpz_t G569;
mpz_init_set_str(G569,"990",10);
mpz_t G570;
mpz_init_set_str(G570,"1000",10);
mpz_mul(G569,G569,G570);
set_pointer_ixx(&value1_2,(G569));
print_string("Value1 redef: ");
prnl_ixx(value1_2);
mpz_t G571;
mpz_init_set_str(G571,"0",10);
create_str_ixx(G571,"500");
println_f64((f64)((100000/100)*(1000-mpz_get_si(G571))));
mpz_t G573;
...
prnl_ixx((ixx_cast)(ixx_cast)(ixx_cast)(G579));
}
}
i32 main()
{
