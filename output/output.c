...
mpz_t G551;
mpz_init_set_str(G551,"1000",10);
mpz_add(G547,G547,G551);
prnl_ixx((ixx_cast)(G547));
mpz_t G552;
mpz_init_set(G552,value1_2);
mpz_t G554;
mpz_init_set(G554,value1_2);
mpz_t G555;
mpz_init_set_str(G555,"0",10);
mpz_mul(G554,G554,value2_2);
mpz_sub(G552,G552,G554);
mpz_t G556;
mpz_init_set_str(G556,"0",10);
mpz_sub(G552,G552,value2_2);
prnl_ixx((ixx_cast)(G552));
mpz_t G557;
mpz_init_set(G557,value1_2);
mpz_t G558;
mpz_init_set_str(G558,"0",10);
mpz_mul(G557,G557,value2_2);
prnl_ixx((ixx_cast)(G557));
mpz_t G559;
mpz_init_set(G559,value1_2);
mpz_t G560;
mpz_init_set_str(G560,"0",10);
mpz_div(G559,G559,value2_2);
prnl_ixx((ixx_cast)(G559));
mpz_t G562;
mpz_init_set_str(G562,"100000",10);
mpz_t G563;
mpz_init_set_str(G563,"100",10);
mpz_div(G562,G562,G563);
mpz_t G565;
mpz_init_set_str(G565,"1000",10);
mpz_t G566;
mpz_init_set_str(G566,"500",10);
mpz_sub(G565,G565,G566);
mpz_mul(G562,G562,G565);
prnl_ixx((ixx_cast)(G562));
mpz_t G568;
mpz_init_set_str(G568,"100000",10);
mpz_t G569;
mpz_init_set_str(G569,"100",10);
mpz_div(G568,G568,G569);
mpz_t G571;
mpz_init_set_str(G571,"1000",10);
mpz_t G572;
mpz_init_set_str(G572,"500",10);
mpz_sub(G571,G571,G572);
mpz_mul(G568,G568,G571);
prnl_ixx((ixx_cast)(ixx_cast)(ixx_cast)(G568));
}
}
i32 main()
{
