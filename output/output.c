...
mpz_mul(G579,G579,G584);
prnl_ixx(sqrt(9(G579));
println_i32((10*pow(2,64)));
mpz_t G589;
mpz_init_set_str(G589,"10",10);
mpz_t G592;
mpz_init_set_str(G592,"2",10);
mpz_t G593;
mpz_init_set_str(G593,"64",10);
mpz_t G594;
mpz_init_set_str(G594,"340282366920938463463374607431768211456",10);
mpz_powm(G592,G592,G593,G594);
mpz_mul(G589,G589,G592);
prnl_ixx((G589));
print_string("Value1 redef: ");
mpz_t G595;
mpz_init_set_str(G595,"500",10);
println_f64((f64)((100000/100)*(1000-mpz_get_si(G595))));
mpz_t G597;
mpz_init_set_str(G597,"100000",10);
mpz_t G598;
mpz_init_set_str(G598,"100",10);
mpz_div(G597,G597,G598);
mpz_t G602;
mpz_init_set_str(G602,"1000",10);
mpz_t G603;
mpz_init_set_str(G603,"500",10);
mpz_sub(G602,G602,G603);
mpz_mul(G597,G597,G602);
prnl_ixx((ixx_cast)(G597));
mpz_t G606;
mpz_init_set_str(G606,"100000",10);
mpz_t G607;
mpz_init_set_str(G607,"100",10);
mpz_div(G606,G606,G607);
mpz_t G611;
mpz_init_set_str(G611,"1000",10);
mpz_t G612;
mpz_init_set_str(G612,"500",10);
mpz_sub(G611,G611,G612);
mpz_mul(G606,G606,G611);
prnl_ixx((ixx_cast)(ixx_cast)(ixx_cast)(G606));
}
}
i32 main()
{
