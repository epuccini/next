...
mpz_t G581;
mpz_init_set_str(G581,"10",10);
mpz_t G584;
mpz_init_set_str(G584,"2",10);
mpz_t G585;
mpz_init_set_str(G585,"64",10);
mpz_t G586;
mpz_init_set_str(G586,"340282366920938463463374607431768211456",10);
mpz_powm(G584,G584,G585,G586);
mpz_mul(G581,G581,G584);
prnl_ixx((G581));
mpz_t G587;
mpz_init_set_str(G587,"990",10);
mpz_t G588;
mpz_init_set_str(G588,"1000",10);
mpz_mul(G587,G587,G588);
set_pointer_ixx(&value1_2,(G587));
print_string("Value1 redef: ");
prnl_ixx(value1_2);
mpz_t G590;
mpz_init_set_str(G590,"0",10);
create_str_ixx(G590,"500");
println_f64((f64)((100000/100)*(1000-mpz_get_si(G590))));
mpz_t G592;
mpz_init_set_str(G592,"100000",10);
mpz_t G593;
mpz_init_set_str(G593,"100",10);
mpz_div(G592,G592,G593);
mpz_t G597;
mpz_init_set_str(G597,"1000",10);
mpz_t G598;
mpz_init_set_str(G598,"500",10);
mpz_sub(G597,G597,G598);
mpz_mul(G592,G592,G597);
prnl_ixx((ixx_cast)(G592));
mpz_t G601;
...
prnl_ixx((ixx_cast)(ixx_cast)(ixx_cast)(G601));
}
}
i32 main()
{
