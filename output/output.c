...
{
mpz_t G547;
mpz_init_set_si(G547,5000);
mpz_t G548;
mpz_init_set_si(G548,2);
mpz_t G549;
mpz_init_set_si(G549,3);
mpz_t G550;
...
mpz_t G590;
mpz_init_set_si(G590,10);
mpz_t G593;
mpz_init_set_si(G593,2);
mpz_t G594;
mpz_init_set_si(G594,64);
mpz_t G595;
...
prnl_ixx((G590));
mpz_t G596;
mpz_init_set_si(G596,990);
mpz_t G597;
mpz_init_set_si(G597,1000);
mpz_mul(G596,G596,G597);
set_pointer_ixx(value1_2,(G596));
print_string("Value1 redef: ");
prnl_ixx(value1_2);
mpz_t G599;
mpz_init_set_si(G599,500);
println_f64((f64)((100000/100)*(1000-mpz_get_si(G599))));
mpz_t G601;
mpz_init_set_si(G601,100000);
mpz_t G602;
mpz_init_set_si(G602,100);
mpz_div(G601,G601,G602);
mpz_t G606;
mpz_init_set_si(G606,1000);
mpz_t G607;
mpz_init_set_si(G607,500);
mpz_sub(G606,G606,G607);
mpz_mul(G601,G601,G606);
prnl_ixx((ixx_cast)(G601));
mpz_t G610;
mpz_init_set_si(G610,100000);
mpz_t G611;
mpz_init_set_si(G611,100);
mpz_div(G610,G610,G611);
mpz_t G615;
mpz_init_set_si(G615,1000);
mpz_t G616;
mpz_init_set_si(G616,500);
