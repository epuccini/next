...
mpz_t G547;
mpz_init(G547);
create_str_ixx(G547,"10000");
prnl_ixx(G547);
prnl_ixx(value1_2);
prnl_ixx(value2_2);
mpz_t G548;
mpz_init_set_str(G548,"0",10);
mpz_add(G548,value1_2,G548);
mpz_t G550;
mpz_init_set_str(G550,"500",10);
mpz_add(G548,G550,G548);
mpz_add(G548,value2_2,G548);
mpz_add(G548,value3_2,G548);
mpz_t G553;
mpz_init_set_str(G553,"1000",10);
mpz_add(G548,G553,G548);
prnl_ixx((G548));
mpz_t G554;
mpz_init_set_str(G554,"0",10);
mpz_sub(G554,value1_2,G554);
mpz_sub(G554,value2_2,G554);
prnl_ixx((G554));
mpz_t G560;
mpz_init_set_str(G560,"1",10);
mpz_mul(G560,value1_2,G560);
mpz_mul(G560,value2_2,G560);
prnl_ixx((G560));
mpz_t G563;
mpz_init_set_str(G563,"1",10);
mpz_div(G563,value1_2,G563);
mpz_div(G563,G563,value2_2);
prnl_ixx((G563));
}
}
i32 main()
