...
mpz_add(G546,value1_2,G546);
mpz_t G548;
mpz_init_set_str(G548,"500",10);
mpz_add(G546,G548,G546);
mpz_add(G546,value2_2,G546);
mpz_add(G546,value3_2,G546);
mpz_t G551;
mpz_init_set_str(G551,"1000",10);
mpz_add(G546,G551,G546);
prnl_ixx((G546));
mpz_t G555;
mpz_init_set_str(G555,"1",10);
mpz_mul(G555,value1_2,G555);
mpz_mul(G555,value2_2,G555);
mpz_t G552;
mpz_init_set_str(G552,"0",10);
mpz_sub(G552,value1_2,G552);
mpz_sub(G552,G552,G555);
mpz_sub(G552,G552,value2_2);
prnl_ixx((G552));
mpz_t G558;
mpz_init_set_str(G558,"1",10);
mpz_mul(G558,value1_2,G558);
mpz_mul(G558,value2_2,G558);
prnl_ixx((G558));
mpz_t G561;
mpz_init_set_str(G561,"1",10);
mpz_div(G561,value1_2,G561);
