...
mpz_t G549;
mpz_init_set_si(G549,2);
mpz_t G550;
mpz_init_set_si(G550,3);
mpz_t G551;
mpz_init_set_si(G551,5000);
mpz_t G552;
mpz_init_set_si(G552,100);
mpz_t G553;
mpz_init_set_si(G553,100);
...
i64 value4_2=mpz_get_si(G551);
ixx value5_2;
mpz_init(value5_2);
mpz_set(value5_2,(G552));
println_string("Bigints!!!");
mpz_t G555;
mpz_init_set_si(G555,10000);
prnl_ixx(G555);
print_string("Value1: ");
prnl_ixx(value1_2);
print_string("Value2: ");
...
mpz_t G557;
mpz_init_set_si(G557,500);
mpz_add(G556,G556,G557);
mpz_add(G556,G556,value2_2);
mpz_add(G556,G556,value3_2);
mpz_t G563;
mpz_init_set_si(G563,1000);
mpz_add(G556,G556,G563);
prnl_ixx((ixx_cast)(G556));
mpz_t G565;
mpz_init_set(G565,value1_2);
mpz_t G568;
mpz_init(G568);
mpz_mul(G568,value1_2,value2_2);
mpz_sub(G565,G565,G568);
mpz_sub(G565,G565,value2_2);
prnl_ixx((ixx_cast)(G565));
mpz_t G573;
mpz_init_set(G573,value1_2);
mpz_mul(G573,G573,value2_2);
...
mpz_t G581;
mpz_init_set_si(G581,100);
mpz_div(G580,G580,G581);
mpz_t G585;
mpz_init_set_si(G585,1000);
mpz_t G586;
mpz_init_set_si(G586,500);
mpz_sub(G585,G585,G586);
mpz_mul(G580,G580,G585);
mpz_t G590;
mpz_init_set_si(G590,9);
mpz_sqrt(G590,G590);
mpz_mul(G580,G580,G590);
mpz_t G593;
mpz_init_set_si(G593,1);
bigint_add_0_ixx(G593);
mpz_mul(G580,G580,result_bigint_add_0_ixx);
prnl_ixx((G580));
mpz_t G595;
...
mpz_t G608;
mpz_init_set_si(G608,1);
bigint_add_0_ixx(G608);
mpz_set(G608,result_bigint_add_0_ixx);
...
prnl_ixx(value1_2);
mpz_t G618;
mpz_init_set_si(G618,500);
println_f64((f64)((100000/100)*(1000-mpz_get_si(G618))));
mpz_t G620;
mpz_init_set_si(G620,100000);
mpz_t G621;
mpz_init_set_si(G621,100);
mpz_div(G620,G620,G621);
mpz_t G625;
mpz_init_set_si(G625,1000);
mpz_t G626;
mpz_init_set_si(G626,500);
mpz_sub(G625,G625,G626);
mpz_mul(G620,G620,G625);
prnl_ixx((ixx_cast)(G620));
mpz_t G629;
mpz_init_set_si(G629,100000);
mpz_t G630;
mpz_init_set_si(G630,100);
mpz_div(G629,G629,G630);
mpz_t G634;
mpz_init_set_si(G634,1000);
mpz_t G635;
mpz_init_set_si(G635,500);
mpz_sub(G634,G634,G635);
mpz_mul(G629,G629,G634);
prnl_ixx((ixx_cast)(ixx_cast)(ixx_cast)(G629));
}
}
i32 main()
{
