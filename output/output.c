...
mpz_t G584;
mpz_init_set_si(G584,4);
extract_digit_0_ui64(mpz_get_si(G584));
mpz_set(G584,result_extract_digit_0_ixx);
if(neq_ui64(d_2,mpz_get_si(G584)))
{
continue;
}
print_ui64(d_2);
