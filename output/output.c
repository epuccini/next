...
{
mpz_t G547;
mpz_init_set(G547,val_1);
mpz_t G548;
mpz_init_set_si(G548,2);
mpz_mul(G547,G547,G548);
mpz_set(result_bigint_add_0_ixx,(G547));
}
void bigints_0_void()
{
{
mpz_t G550;
mpz_init_set_str(G550,"5000",10);
mpz_t G551;
mpz_init_set_str(G551,"2",10);
mpz_t G552;
mpz_init_set_str(G552,"3",10);
mpz_t G553;
mpz_init_set_str(G553,"5000",10);
mpz_t G554;
mpz_init_set_si(G554,100);
mpz_t G555;
mpz_init_set_si(G555,100);
mpz_add(G554,G554,G555);
ixx value1_2;
mpz_init(value1_2);
mpz_set(value1_2,G550);
ixx value2_2;
mpz_init(value2_2);
mpz_set(value2_2,G551);
ixx value3_2;
mpz_init(value3_2);
mpz_set(value3_2,G552);
i64 value4_2=mpz_get_si(G553);
ixx value5_2;
mpz_init(value5_2);
mpz_set(value5_2,(G554));
println_string("Bigints!!!");
mpz_t G557;
mpz_init_set_str(G557,"10000",10);
prnl_ixx(G557);
print_string("Value1: ");
prnl_ixx(value1_2);
print_string("Value2: ");
...
mpz_t G559;
mpz_init_set_si(G559,500);
mpz_add(G558,G558,G559);
mpz_add(G558,G558,value2_2);
mpz_add(G558,G558,value3_2);
mpz_t G565;
mpz_init_set_si(G565,1000);
mpz_add(G558,G558,G565);
prnl_ixx((ixx_cast)(G558));
mpz_t G567;
mpz_init_set(G567,value1_2);
mpz_t G570;
mpz_init(G570);
mpz_mul(G570,value1_2,value2_2);
mpz_sub(G567,G567,G570);
mpz_sub(G567,G567,value2_2);
prnl_ixx((ixx_cast)(G567));
mpz_t G575;
mpz_init_set(G575,value1_2);
mpz_mul(G575,G575,value2_2);
prnl_ixx((ixx_cast)(G575));
mpz_t G578;
mpz_init_set(G578,value1_2);
mpz_div(G578,G578,value2_2);
prnl_ixx((ixx_cast)(G578));
println_i32(((100000/100)*(1000-500)*sqrt(9)));
mpz_t G582;
mpz_init_set_si(G582,100000);
mpz_t G583;
mpz_init_set_si(G583,100);
mpz_div(G582,G582,G583);
mpz_t G587;
mpz_init_set_si(G587,1000);
mpz_t G588;
mpz_init_set_si(G588,500);
mpz_sub(G587,G587,G588);
mpz_mul(G582,G582,G587);
mpz_t G592;
mpz_init_set_si(G592,9);
mpz_sqrt(G592,G592);
mpz_mul(G582,G582,G592);
mpz_t G595;
mpz_init_set_str(G595,"1",10);
bigint_add_0_ixx(G595);
mpz_mul(G582,G582,result_bigint_add_0_ixx);
prnl_ixx((G582));
mpz_t G597;
mpz_init_set_si(G597,100000);
mpz_t G598;
mpz_init_set_si(G598,100);
mpz_div(G597,G597,G598);
mpz_t G602;
mpz_init_set_si(G602,1000);
mpz_t G603;
mpz_init_set_si(G603,500);
mpz_sub(G602,G602,G603);
mpz_mul(G597,G597,G602);
mpz_t G607;
mpz_init_set_si(G607,9);
mpz_sqrt(G607,G607);
mpz_mul(G597,G597,G607);
mpz_t G610;
mpz_init_set_str(G610,"1",10);
bigint_add_0_ixx(G610);
mpz_set(G610,result_bigint_add_0_ixx);
mpz_mul(G597,G597,G610);
prnl_ixx((G597));
println_i32((10*pow(2,16)));
mpz_t G611;
mpz_init_set_si(G611,10);
mpz_t G614;
mpz_init_set_si(G614,2);
mpz_t G615;
mpz_init_set_si(G615,64);
mpz_t G616;
mpz_init_set_str(G616,"340282366920938463463374607431768211456",10);
mpz_powm(G614,G614,G615,G616);
mpz_mul(G611,G611,G614);
prnl_ixx((G611));
mpz_t G617;
mpz_init_set_si(G617,990);
mpz_t G618;
mpz_init_set_si(G618,1000);
mpz_mul(G617,G617,G618);
set_pointer_ixx(value1_2,(G617));
print_string("Value1 redef: ");
prnl_ixx(value1_2);
mpz_t G620;
mpz_init_set_str(G620,"500",10);
println_f64((f64)((100000/100)*(1000-mpz_get_si(G620))));
mpz_t G622;
mpz_init_set_si(G622,100000);
mpz_t G623;
mpz_init_set_si(G623,100);
mpz_div(G622,G622,G623);
mpz_t G627;
mpz_init_set_si(G627,1000);
mpz_t G628;
mpz_init_set_si(G628,500);
mpz_sub(G627,G627,G628);
mpz_mul(G622,G622,G627);
prnl_ixx((ixx_cast)(G622));
mpz_t G631;
mpz_init_set_si(G631,100000);
mpz_t G632;
mpz_init_set_si(G632,100);
mpz_div(G631,G631,G632);
mpz_t G636;
mpz_init_set_si(G636,1000);
mpz_t G637;
mpz_init_set_si(G637,500);
mpz_sub(G636,G636,G637);
mpz_mul(G631,G631,G636);
prnl_ixx((ixx_cast)(ixx_cast)(ixx_cast)(G631));
}
}
i32 main()
{
