...
{
mpz_t G547;
mpz_init_set_str(G547,"5000",10);
mpz_t G548;
mpz_init_set_str(G548,"2",10);
mpz_t G549;
mpz_init_set_str(G549,"3",10);
mpz_t G550;
mpz_init_set_str(G550,"5000",10);
mpz_t G551;
mpz_init_set_str(G551,"100",10);
mpz_t G552;
mpz_init_set_str(G552,"100",10);
mpz_add(G551,G551,G552);
ixx value1_2;
mpz_init(value1_2);
mpz_set(value1_2,G547);
ixx value2_2;
mpz_init(value2_2);
mpz_set(value2_2,G548);
ixx value3_2;
mpz_init(value3_2);
mpz_set(value3_2,G549);
i64 value4_2=mpz_get_si(G550);
ixx value5_2;
mpz_init(value5_2);
...
mpz_t G584;
mpz_init_set_str(G584,"1000",10);
mpz_t G585;
mpz_init_set_str(G585,"500",10);
mpz_sub(G584,G584,G585);
mpz_mul(G579,G579,G584);
mpz_t G589;
mpz_init_set_str(G589,"9",10);
mpz_sqrt(G589,G589);
mpz_mul(G579,G579,G589);
prnl_ixx((G579));
println_f64((10*pow(2,64)));
mpz_t G590;
mpz_init_set_str(G590,"10",10);
mpz_t G593;
mpz_init_set_str(G593,"2",10);
mpz_t G594;
mpz_init_set_str(G594,"64",10);
mpz_t G595;
mpz_init_set_str(G595,"340282366920938463463374607431768211456",10);
mpz_powm(G593,G593,G594,G595);
mpz_mul(G590,G590,G593);
prnl_ixx((G590));
mpz_t G596;
mpz_init_set_str(G596,"990",10);
mpz_t G597;
...
println_f64((f64)((100000/100)*(1000-mpz_get_si(G599))));
mpz_t G601;
mpz_init_set_str(G601,"100000",10);
mpz_t G602;
mpz_init_set_str(G602,"100",10);
mpz_div(G601,G601,G602);
mpz_t G606;
mpz_init_set_str(G606,"1000",10);
mpz_t G607;
mpz_init_set_str(G607,"500",10);
mpz_sub(G606,G606,G607);
mpz_mul(G601,G601,G606);
prnl_ixx((ixx_cast)(G601));
mpz_t G610;
mpz_init_set_str(G610,"100000",10);
mpz_t G611;
mpz_init_set_str(G611,"100",10);
mpz_div(G610,G610,G611);
mpz_t G615;
mpz_init_set_str(G615,"1000",10);
mpz_t G616;
mpz_init_set_str(G616,"500",10);
mpz_sub(G615,G615,G616);
mpz_mul(G610,G610,G615);
prnl_ixx((ixx_cast)(ixx_cast)(ixx_cast)(G610));
}
}
i32 main()
{
