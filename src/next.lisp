...
(defun setup-signatures ()
  ...
  (setf (gethash "size" *signatures*) '("void" "array"))
  (setf (gethash "@" *signatures*) '("void" "array"))
  (setf (gethash "new_bool" *signatures*) '("array" "value"))
  (setf (gethash "new_b8" *signatures*) '("array" "value"))
  (setf (gethash "new_c8" *signatures*) '("array" "value"))
  (setf (gethash "new_i16" *signatures*) '("array" "value"))
  (setf (gethash "new_i32" *signatures*) '("array" "value"))
  (setf (gethash "new_i64" *signatures*) '("array" "value"))
  (setf (gethash "new_f32" *signatures*) '("array" "value"))
  (setf (gethash "new_f64" *signatures*) '("array" "value"))  
  ...
  (setf (gethash "bool>" *signatures*) '("array" "value"))
  (setf (gethash "b8>" *signatures*) '("array" "array"))
  (setf (gethash "c8>" *signatures*) '("array" "array"))
  (setf (gethash "i16>" *signatures*) '("array" "array"))
  (setf (gethash "i32>" *signatures*) '("array" "array"))
  (setf (gethash "i64>" *signatures*) '("array" "array"))
  (setf (gethash "f32>" *signatures*) '("array" "array"))
  (setf (gethash "f64>" *signatures*) '("array" "array"))  
