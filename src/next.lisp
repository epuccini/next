...
(defun setup-signatures ()
  ...
  (setf (gethash "read-line" *signatures*) '("value" "value"))
  (setf (gethash "write-line" *signatures*) '("void" "value" "value"))
  ...
  (set-function-type "read-line" 'char-array)
  (set-function-type "write-line" 'void)
