  ...
  (cond ((equal "(" (car expr-list))
        ...
        ((equal "push" (car expr-list))
         (let ((type (get-type expr-list)))
           ...
           (add-code (format nil "push_node_~a" type))
           (add-code "(")
           (zero-arg)
           (setf expr-list (parse-arguments (cdr expr-list) 2))
           (return-from parse-call expr-list)))
        ((equal "car" (car expr-list))
         (let ((type (get-type expr-list)))
           ...
           (add-code (format nil "car_node_~a" type))
           (add-code "(")
           (zero-arg)
           (setf expr-list (parse-arguments (cdr expr-list) 1))
           (return-from parse-call expr-list)))
        ((equal "cdr" (car expr-list))
         (let ((type (get-type expr-list)))
           ...
           (add-code (format nil "cdr_node_~a" type))
           (add-code "(")
           (zero-arg)
           (setf expr-list (parse-arguments (cdr expr-list) 2))
           (return-from parse-call expr-list)))
        ((equal "append" (car expr-list))
         (let ((type (get-type expr-list)))
           ...
           (add-code (format nil "append_node_~a" type))
           (add-code "(")
           (zero-arg)
           (setf expr-list (parse-arguments (cdr expr-list) 2))
           (return-from parse-call expr-list)))
        ((equal "remove" (car expr-list))
         (let ((type (get-type expr-list)))
           ...
           (add-code (format nil "remove_node_~a" type))
           (add-code "(")
           (zero-arg)
           (setf expr-list (parse-arguments (cdr expr-list) 1))
           (return-from parse-call expr-list)))
        ((equal "pop" (car expr-list))
         (let ((type (get-type expr-list)))
           ...
           (add-code (format nil "pop_node_~a" type))
           (add-code "(")
           (add-code "&")
           (zero-arg)
           (setf expr-list (parse-arguments (cdr expr-list) 1))
